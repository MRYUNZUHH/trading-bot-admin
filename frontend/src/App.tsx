  ...
  return (
    <div className={'bg-gray-900 text-white h-screen transition-all duration-300 ' + (collapsed ? 'w-20' : 'w-64') + ' flex flex-col'}>
      ...
      <div className="p-4 border-t border-gray-800">
        <button onClick={() => { localStorage.removeItem('accessToken'); window.location.href = '/login' }} className="flex items-center text-gray-400 hover:text-white w-full px-4 py-2 rounded-lg hover:bg-gray-800">
          <LogOut size={20} />
...
function Dashboard() {
  ...
  const recentTrades = [
    ...
    { symbol: 'BTC/USD', type: 'SELL', entry: 42500, current: 42350, pnl: 150.00, pnlPercent: 0.35 },
  ]
      ...
      <div className="p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div className="h-64 flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg border-2 border-dashed border-gray-200">
              <div className="text-center">
                <BarChart3 size={48} className="text-blue-400 mx-auto mb-2" />
                <span className="text-gray-600 font-medium">Equity Chart</span>
                <p className="text-sm text-gray-500 mt-1">+$12,345.67 this month</p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-medium">{telegramStatus.activeChannels}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Daily Signals</span>
                  <span className="font-medium">{telegramStatus.dailySignals}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-600">Last Signal</span>
                  <span className="font-medium">{telegramStatus.lastSignal}</span>
                </div>
              </div>
            </div>
...
function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => { e.preventDefault(); setLoading(true); setTimeout(() => { localStorage.setItem('accessToken', 'fake-token'); window.location.href = '/dashboard' }, 1000) }
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-96">
        ...
        <p className="mt-6 text-center text-sm text-gray-600">Demo: any email/password works</p>
      </div>
    </div>
  )
}
