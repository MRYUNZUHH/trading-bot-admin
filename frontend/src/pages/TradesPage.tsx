...
export default function TradesPage() {
  ...
  const trades = [
    ...
    { id: 5, symbol: 'BTC/USD', type: 'SELL', entry: 42500, exit: null, quantity: 0.1, pnl: 150.00, pnlPercent: 0.35, status: 'open', openTime: '2024-01-20 11:00', closeTime: null, channel: 'Crypto Signals' },
  ]
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 mb-6">
          ...
          <div className="bg-white rounded-lg border p-3">
            ...
            <p className="text-xl font-bold text-green-600">${stats.totalPnL.toLocaleString()}</p>
          </div>
          <div className="bg-white rounded-lg border p-3">
          ...
          <div className="bg-white rounded-lg border p-3">
            ...
            <p className="text-xl font-bold text-red-600">${stats.avgLoss}</p>
          </div>
        </div>
        ...
        <div className="flex gap-4 mb-6">
          <div className="flex-1 relative">
            ...
            <input type="text" placeholder="Search by symbol..." className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
          ...
          <select className="px-4 py-2 border border-gray-300 rounded-lg">
            ...
            <option>Gold Signals</option>
            <option>Crypto Signals</option>
          </select>
            ...
            <tbody className="divide-y divide-gray-200">
              {trades.map((trade) => (
                <tr key={trade.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-gray-600">{trade.quantity}</td>
